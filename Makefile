...
KIND_CLUSTER ?= kiro-crew-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kiro-crew-operator-builder
	$(CONTAINER_TOOL) buildx use kiro-crew-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm kiro-crew-operator-builder
	rm Dockerfile.cross
...
HELM_NAMESPACE ?= kiro-crew-operator-system
## Name of the Helm release
HELM_RELEASE ?= kiro-crew-operator
