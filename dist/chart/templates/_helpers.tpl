...
*/}}
{{- define "kiro-crew-operator.name" -}}
...
*/}}
{{- define "kiro-crew-operator.fullname" -}}
...
*/}}
{{- define "kiro-crew-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "kiro-crew-operator.resourceName" -}}
{{- $fullname := include "kiro-crew-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "kiro-crew-operator.serviceAccountName" -}}
{{- if .Values.serviceAccount.enabled }}
{{- include "kiro-crew-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- else }}
